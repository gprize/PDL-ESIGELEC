...
public class justificatif_valide {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					justificatif_valide window = new justificatif_valide();
	...
	private void initialize() {
		...
		JCheckBox chckbxNewCheckBox = new JCheckBox("Validé");
		chckbxNewCheckBox.setBounds(337, 94, 93, 21);
		frame.getContentPane().add(chckbxNewCheckBox);
		
		JCheckBox chckbxRefus = new JCheckBox("Validé");
		chckbxRefus.setBounds(337, 129, 93, 21);
		frame.getContentPane().add(chckbxRefus);
		
		JCheckBox chckbxRefus_1 = new JCheckBox("Validé");
