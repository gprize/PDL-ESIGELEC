...
public class choix_justificatif {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					choix_justificatif window = new choix_justificatif();
	...
	private void initialize() {
		...
		JCheckBox chckbxRefus = new JCheckBox("");
		chckbxRefus.setBounds(337, 129, 93, 21);
		frame.getContentPane().add(chckbxRefus);
		
		JCheckBox chckbxRefus_1 = new JCheckBox("");
